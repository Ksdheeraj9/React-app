...
export class ChordComponent extends Component{
  ...
  componentDidMount(){
    ...
    state.colors = d3.scale.ordinal()
      .range(['#94618e', '#49274a', '#f4decb', '#f8ee7', '#0b3c5d', '#328cc1', '#d9b310', '#015249', '#ab987a', '#ff533d', '#34e0ee', '#01abaa','#000000','#36352B','#33332F','#998476','#8A968D','#968D8A','#968D96','#CC855C', '#967860','#929488','#949278','#A0A3BD','#BD93A1','#65666B','#6B5745','#6B6664','#695C52','#56695E','#69545C','#565A69','#696043','#63635C','#636150','#333131','#332820','#302D30','#302D1F','#2D302F','#CFB6A3','#362F2A']);
    ...
    state.arc = d3.svg.arc()
      ...
      .outerRadius(state.innerRadius + 20);
